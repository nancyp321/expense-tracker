...
1. Generates a realistic random Russian user using your 
   own knowledge of common Russian names across regions:
   - Name: a realistic Russian first + last name
   - Email: derived from the name with a random 2-3 digit 
     number suffix (e.g. alek.zal@gmail.com)
